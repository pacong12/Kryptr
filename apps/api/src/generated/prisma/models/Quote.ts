...
export type QuoteWhereInput = {
  ...
  payload?: Prisma.JsonFilter<"Quote">
  storedAt?: Prisma.DateTimeFilter<"Quote"> | Date | string
}
...
export type QuoteScalarWhereWithAggregatesInput = {
  ...
  payload?: Prisma.JsonWithAggregatesFilter<"Quote">
  storedAt?: Prisma.DateTimeWithAggregatesFilter<"Quote"> | Date | string
}
...
export type QuoteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"quoteId" | "payload" | "storedAt", ExtArgs["result"]["quote"]>
...
export interface QuoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const quoteWithQuoteIdOnly = await prisma.quote.findMany({ select: { quoteId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Quotes and only return the `quoteId`
   * const quoteWithQuoteIdOnly = await prisma.quote.createManyAndReturn({
   *   select: { quoteId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Quotes and only return the `quoteId`
   * const quoteWithQuoteIdOnly = await prisma.quote.updateManyAndReturn({
   *   select: { quoteId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface QuoteFieldRefs {
  ...
  readonly payload: Prisma.FieldRef<"Quote", 'Json'>
  readonly storedAt: Prisma.FieldRef<"Quote", 'DateTime'>
}
