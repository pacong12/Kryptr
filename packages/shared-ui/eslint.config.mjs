...
// (conductor approval). React TSX components and all TypeScript
// (index barrels, lib utils) are fully covered.
export default tseslint.config(
  {
    name: 'kryptr/shared-ui/ignores',
    ignores: ['dist/**'],
  },
  {
    name: 'kryptr/shared-ui/eslint-recommended',
    rules: eslintRecommended,
  },
  ...tseslint.configs.recommended,
  {
    name: 'kryptr/shared-ui/rules',
    rules: {
